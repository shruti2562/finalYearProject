...
<body>
 		...
 		<div class="form">
             ...
             <!-- Register form Start -->
 			 <div class="register-form form-hidden">
 			 	...
 			 	<div class="form-group">
 			 		<input type="text" name="college_id" placeholder="College ID" class="form-control">
 			 	</div>
 			 	<div class="form-group">
 			 		<input type="text" name="college" placeholder="College Name" class="form-control">
 			 	</div>
 			 	<div class="form-group">
 			 		<input type="text" name="sli" placeholder="Student Login ID" class="form-control">
 			 	</div>
 			 	<div class="form-group">
 			 		<input type="text" name="tli" placeholder="Teacher Login ID" class="form-control">
 			 	</div>
 ...
 <script type="text/javascript" src="../assets/js/clgvalidation.js"></script>
</body>
</html>
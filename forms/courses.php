...
/*.carousel .thumb-wrapper:first-child
{
	margin-left: 25px;
}

.carousel .thumb-wrapper:nth-child(4)
{
	margin-right: 25px;
}*/
...
<div class="main">
	<div class="row">
		<div class="col-md-12">
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								...
								<div class="img-box">
									<img src="../img/php1.jpg" class="img-fluid" alt="">									
								</div>
						...
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<span class="wish-icon"><i class="fa fa-heart-o"></i></span>
								<div class="img-box">
									<img src="../img/java1.png" class="img-fluid" alt="Headphone">
								</div>
								<div class="thumb-content">
									<h4>Learn Java with projects</h4>									
						...
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<span class="wish-icon"><i class="fa fa-heart-o"></i></span>
								<div class="img-box">
									<img src="../img/angular1.jpg" class="img-fluid" alt="Macbook">
								</div>
								<div class="thumb-content">
									<h4>Crud application using Angular</h4>									
						...
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<span class="wish-icon"><i class="fa fa-heart-o"></i></span>
								<div class="img-box">
									<img src="../img/hcj1.png" class="img-fluid" alt="Nikon">
								</div>
								<div class="thumb-content">
			...
			<!-- Carousel controls -->
			<a class="carousel-control-prev" style="margin: 100px 0;" href="#myCarousel1" data-slide="prev">
				<i class="fa fa-angle-left" style="color: grey;"></i>
			</a>
			<a class="carousel-control-next" style="margin: 100px 0;" href="#myCarousel1" data-slide="next">
				<i class="fa fa-angle-right" style="color: grey;"></i>
			</a>
		</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<!-- Carousel controls -->
			<a class="carousel-control-prev" style="margin: 120px 0;" href="#myCarousel2" data-slide="prev">
				<i class="fa fa-angle-left" style="color: grey;"></i>
			</a>
			<a class="carousel-control-next" style="margin: 120px 0;" href="#myCarousel2" data-slide="next">
				<i class="fa fa-angle-right" style="color: grey;"></i>
			</a>
		</div>
		</div>
